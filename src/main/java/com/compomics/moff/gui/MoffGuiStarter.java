package com.compomics.moff.gui;

import com.compomics.moff.gui.view.MainController;
 ...
 */
public class MoffGuiStarter {

    /**
     * Logger instance.
     */
    private static final Logger LOGGER = Logger.getLogger(MoffGuiStarter.class);
    ...
    public static void main(final String[] args) {
        ...
        MoffGuiStarter scorePipelineStarter = new MoffGuiStarter();
    ...
    private void launch() {
        try {
            ...
            JOptionPane.showMessageDialog(null, scrollPane, "Moff GUI startup error", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
    }
}
